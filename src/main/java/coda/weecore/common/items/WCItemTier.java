...
public enum WCItemTier implements IItemTier {
    EXAMPLE_TIER(2, 150, 6.0F, 2.0F, 25, () -> {
    ...
    private WCItemTier(int p_i48458_3_, int p_i48458_4_, float p_i48458_5_, float p_i48458_6_, int p_i48458_7_, Supplier<Ingredient> p_i48458_8_) {
